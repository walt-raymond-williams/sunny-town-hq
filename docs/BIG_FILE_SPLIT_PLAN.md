...
| --- | ---: | --- | --- |
| `frontend/src/features/sunny-town/SunnyTownPage.vue` | 1,554 | High | Still holds orchestration, remote interpolation, local prediction, NPC interaction, shop/schoolwork commands, placement, and drawing helpers. |
